...
set_property PACKAGE_PIN AB5 [get_ports {o_SPI_MOSI}];  # "AC-SDA"
...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {o_RX_DV}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {o_RX_Byte}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {i_TX_Byte}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {i_TX_DV}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {o_TX_Ready}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {o_TX_Ready}];  # "JA7"
...
# HDMI Output - Bank 33
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W18  [get_ports {i_Clk}];  # "HD-CLK"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN G17 [get_ports {i_Rst_L}];  # "OTG-RESETN"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN R7 [get_ports {o_SPI_Clk}];  # "FMC-SCL"
set_property PACKAGE_PIN U7 [get_ports {i_SPI_MISO}];  # "FMC-SDA"
